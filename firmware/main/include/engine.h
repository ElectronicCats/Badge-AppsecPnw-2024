...
typedef struct {
  ...
  PlayerInformation attacker;
  PlayerInformation opponent;
 ...
 */
extern void get_owasp_profile_cwe_uint8(uint8_t* dest_buffer,
 ...
 * @return The CWE value.
 */
extern void create_owasp_commmand_identifier(uint8_t* dest_buffer,
                                             OWASPBaseAction* attack);
