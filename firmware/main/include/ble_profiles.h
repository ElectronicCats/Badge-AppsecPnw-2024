...
void board_exce_write_event(prepare_type_env_t* prepare_write_env,
                            esp_ble_gatts_cb_param_t* param);
extern void gatts_profiles_event_handler(esp_gatts_cb_event_t event,
                                         esp_gatt_if_t gatts_if,
                                         esp_ble_gatts_cb_param_t* param);

extern void get_player_array(esp_gatt_rsp_t* response_information,
                             PlayerInformation player);
extern void get_player_array_uint8(uint8_t* response_information,
                                   PlayerInformation player);
extern void get_profile_owasp_array(esp_gatt_rsp_t* response_information,
                                    OWASPProfile* profile);
extern void get_profile_owasp_uint8(uint8_t* response_information,
                                    OWASPProfile* profile);
